...
def HauptMenue():
    ...
    Nutzernametitel_label = HAUPTMENUE.Label(PersonalRahmen, text="PERSONAL ANLEGEN/ÄNDERN/LÖSCHEN", fg='#2F4F4F', bg='#BDBDBD', font=('courier', 14), width=31, heigh=1)
    Nutzernametitel_label.grid(row=0, column=0, padx='5', pady='5', sticky='nw', columnspan=5)

    Nutzernameleer_label = HAUPTMENUE.Label(PersonalRahmen, text=" ", fg='#2F4F4F', bg='#BDBDBD', font=('courier', 12), width=31, heigh=1)
    Nutzernameleer_label.grid(row=1, column=0, padx='5', pady='5', sticky='nw', columnspan=5)

    Nutzername_label = HAUPTMENUE.Label(PersonalRahmen, text="Benutzername", fg='#2F4F4F', bg='#BDBDBD', font=('courier', 12,), width=12, heigh=1)
    Nutzername_label.grid(row=2, column=0, padx='5', pady='5', sticky='nw')

    Nutzerpasswort_label = HAUPTMENUE.Label(PersonalRahmen, text="Passwort", fg='#2F4F4F', bg='#BDBDBD', font=('courier', 12,), width=8, heigh=1)
    ...
    for i in User.objects():
        listboxNutzer.insert(1, f'Benutzername: {username[user_number]}    Passwort: {userpassword[user_number]}')
        user_number =+ 1
    ...
    HautbuttonDrucken = HAUPTMENUE.Button(Hautbuttonumrandung, text="Personal", command=PersonalbuttonClick).grid(row=8, column=0, padx='10', pady='20', sticky='ew')
